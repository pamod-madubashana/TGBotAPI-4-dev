      ...
      {currentView.kind === "method" && (
        <div className="flex items-center gap-1.5">
          ...
          <button
            ...
            className="h-7 px-3 flex items-center gap-1.5 rounded-md text-xs bg-primary text-primary-foreground hover:bg-primary/90 transition disabled:opacity-40 disabled:cursor-not-allowed"
          >
